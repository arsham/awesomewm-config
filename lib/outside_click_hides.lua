...
local function click_hides(widget, hide_fct, only_outside)
...
local function click_hides_menu(menu, hide_fct, outside_only)
  if menu == nil then
    return
  end
  ...
  click_hides(menu.wibox, hide_fct, outside_only)
end

return {
  menu = click_hides_menu,
  popup = click_hides,
}
